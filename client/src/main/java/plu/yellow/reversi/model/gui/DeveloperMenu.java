...
public class DeveloperMenu extends JMenu implements ActionListener {
    ...
    private JMenuItem letAIMoveItem;
    private JMenuItem aiTestGame;
    ...
    public DeveloperMenu(GameWindow gui) {
        ...
        letAIMoveItem = new JMenuItem("Let AI Select Move");
        letAIMoveItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, ActionEvent.META_MASK));
        letAIMoveItem.addActionListener(this);
        this.add(letAIMoveItem);

        aiTestGame = new JMenuItem("Test Game");
        aiTestGame.addActionListener(this);
        this.add(aiTestGame);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == testFlipAnimItem) {
            ...
            testServer();
        } else if( e.getSource() == letAIMoveItem) {
            letAiMove();
        }
    }
    ...
    private void letAiMove() {
        ReversiAI ai = new ReversiAI(3);
        ai.playBestMove(gui.getBoard(),activePlayer);
